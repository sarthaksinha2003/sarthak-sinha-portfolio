...
const experiences = [
  {
    ...
    tech: ["SDLC", "SQL Anywhere", "GitLab", "Agile"],
    highlight: "100,000+ users served",
  },
  {
    ...
    tech: ["Java", "Spring Boot", "MySQL", "Node.js", "JWT", "REST API"],
    highlight: "3x system scalability improvement",
  },
];

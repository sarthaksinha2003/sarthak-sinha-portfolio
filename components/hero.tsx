...
// LeetCode icon component - official LeetCode logo with better visibility
      ...
      >
        <motion.div variants={fadeUp} className="flex flex-col items-center gap-6">
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-4 mt-8">
            {[
              { icon: Github, href: "https://github.com/sarthaksinha2003", label: "GitHub" },
              { icon: Linkedin, href: "https://linkedin.com/in/sarthak-sinha-9b8535324", label: "LinkedIn" },
              { icon: Mail, href: "mailto:sarthaksinha38@gmail.com", label: "Email" },
              { icon: LeetCodeIcon, href: "https://leetcode.com/u/Sarthak-Sinha/", label: "LeetCode" },
